...
Voltage in $R_1$:
\[V_{R1} = R_1\cdot I_1 =(\SI{680}{\ohm})(\SI{2.151}{\milli\ampere})\qquad\therefore V_{R1} =
\SI{1.463}{\volt}\]
Voltage in $R_2$:
\[V_{R2} = R_2\cdot(I_2-I_1) =(\SI{1}{\kilo\ohm})(\SI{8.397}{\milli\ampere}-\SI{2.151}{\milli\ampere})\qquad\therefore V_{R2} =
\SI{6.246}{\volt}\]
Voltage in $R_3$:
\[V_{R3} = R_3\cdot(I_3-I_1) =(\SI{560}{\ohm})(\SI{2.537}{\milli\ampere}-\SI{2.151}{\milli\ampere})\qquad\therefore V_{R3} =
\SI{0.216}{\volt}\]
Voltage in $R_4$:
\[V_{R4} = R_4\cdot(I_2-I_3) =(\SI{470}{\ohm})(\SI{8.397}{\milli\ampere}-\SI{2.537}{\milli\ampere})\qquad\therefore V_{R4} =
\SI{2.754}{\volt}\]
Voltage in $R_5$:
\[V_{R5} = R_5\cdot I_3 =(\SI{1}{\kilo\ohm})(\SI{2.537}{\milli\ampere})\qquad\therefore V_{R5} =
\SI{2.537}{\volt}\]
